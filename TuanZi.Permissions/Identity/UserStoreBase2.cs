...
{
    public abstract class UserStoreBase2<TUser, TUserKey, TUserClaim, TUserLogin, TUserToken, TRole, TRoleKey, TUserRole>
    ...
    {
        protected readonly IRepository<TUser, TUserKey> _userRepository;
        protected readonly IRepository<TUserLogin, Guid> _userLoginRepository;
        protected readonly IRepository<TUserClaim, int> _userClaimRepository;
        protected readonly IRepository<TUserToken, Guid> _userTokenRepository;
        protected readonly IRepository<TRole, TRoleKey> _roleRepository;
        protected readonly IRepository<TUserRole, Guid> _userRoleRepository;
        protected readonly IEventBus _eventBus;
        protected bool _disposed;

        protected UserStoreBase2(
