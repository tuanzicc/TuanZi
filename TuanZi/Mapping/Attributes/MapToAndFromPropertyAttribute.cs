...
namespace TuanZi.Mapping
{
    ...
    public class MapToAndFromPropertyAttribute : MapPropertyAttribute
    {
        /// <summary>
        ...
        public MapToAndFromPropertyAttribute(Type sourceOrTargetType, string propertyName)
        {
            SourceOrTargetType = sourceOrTargetType;
            PropertyName = propertyName;
        }

        public override IEnumerable<PropertyMapInfo> GetPropertyMapInfo(PropertyInfo targetProperty, Type sourceType = null)
        {
